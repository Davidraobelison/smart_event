...
import { CreditCard, TrendingUp, CheckCircle, X, Eye } from "lucide-react";
    ...
    return (
        <div className={styles.page}>
            ...
            <div className={styles.tableCard}>
                <div className={styles.tableCardHeader}><span className={styles.tableCardTitle}>Abonnements en cours ({subscriptions.length})</span></div>
