...
export default function PrestataireDashboard() {
    ...
    const stats = [
        { title: t("nav.missions") || "Missions",  value: "8",    icon: Briefcase,   color: "blue"    },
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-lg)", animation: "fadeIn 0.5s ease-out" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(400px, 1fr))", gap: "var(--space-lg)" }}>
                <Card>
                    <Card.Header divider><Card.Title>Mes prochaines missions</Card.Title></Card.Header>
                    <Card.Body>
                ...
                <Card>
                    <Card.Header divider><Card.Title>Dernières demandes</Card.Title></Card.Header>
                    <Card.Body>
                        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-md)" }}>
                            {[1, 2].map(i => (
                                <div key={i} style={{ display: "flex", gap: "var(--space-md)", padding: "var(--space-sm)", backgroundColor: "var(--color-surface-2)", borderRadius: "var(--radius-md)", border: "1px solid var(--color-border)" }}>
                                    <div style={{ flex: 1 }}>
                                        ...
                                        <p style={{ fontSize: "var(--fs-xs)", color: "var(--color-muted)", marginBottom: "var(--space-sm)" }}>Besoin : Cocktail dinatoire pour 150 pers.</p>
