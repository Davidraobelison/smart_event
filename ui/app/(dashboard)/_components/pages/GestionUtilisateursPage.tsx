...
const roleBadge:  Record<string, "primary" | "info" | "success"> = { ORGANIZER: "primary", CLIENT: "info", PROVIDER: "success" };
                    ...
                    <tbody className={styles.tbody}>
                        {filtered.map(u => (
                            <tr key={u.id}>
                                ...
                                <td style={{ textAlign: "right" }}><button className={styles.actionBtnGhost} style={{ padding: "4px 10px", fontSize: "11px" }}>Gérer</button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
